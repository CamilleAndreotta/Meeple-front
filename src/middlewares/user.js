...
const userMiddleware = (store) => (next) => (action) => {
  ...
  switch (action.type) {
    ...
    case FETCH_FORM_SIGNIN: {
      ...
      axios.post('http://camilleandreotta-server.eddi.cloud/meeple/current/public/api/users',
    ...
    case VOTE: {
      ...
      axios.post('http://camilleandreotta-server.eddi.cloud/meeple/current/public/api/reviews',
    ...
    case FETCH_LOGIN: {
      ...
      axios.post('http://camilleandreotta-server.eddi.cloud/meeple/current/public/api/login_check',
        {
          username: email,
          password: password,
        },
    ...
    case FETCH_USER_WITH_MAIL: {
     ...
     //const testMail = email.replace(' ', '');
      ...
      axios.post(
        'http://camilleandreotta-server.eddi.cloud/meeple/current/public/api/users/custom',
